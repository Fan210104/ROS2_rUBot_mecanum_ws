...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_selfcontrol_holo_exec = my_robot_control.my_robot_selfcontrol_holo:main',
            ...
            'my_robot_wallfollower_holonomic_100_exec = my_robot_control.my_robot_wallfollower_holonomic_100:main',
